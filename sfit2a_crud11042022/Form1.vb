Imports sfit2a_crud11042022.Module1
...
Public Class Form1
    ...
    Dim course1, section1, id As Int64
    ...
    Public Sub sponge()
        con1 = New SqlClient.SqlConnection
        con1.ConnectionString = "Data Source=DESKTOP-G6V20H0\SQL_SERVER;Initial Catalog=sfit2a_relational;User ID=sa;Password=1234;Pooling=False"
        'Dim viewrecords = "SELECT id, firstname, lastname, course_desc, sectionname FROM viewrec" THIS IS FOR VIEW
...
"
    ...
    Private Sub update_Click(sender As Object, e As EventArgs) Handles update.Click
        Try
            ...
            course1 = ComboBox1.SelectedValue
            section1 = ComboBox2.SelectedValue
            Dim updaterow = "UPDATE updaterec SET firstname = '" & firstname1 & "', lastname = '" & lastname1 & "', courseid = '" & course1 & "', sectionid = '" & section1 & "'WHERE id = " & id & "" 'VIEW
            'Dim updaterow = "UPDATE students_table SET firstname = '" & firstname1 & "', lastname = '" & lastname1 & "', courseid = '" & course1 & "', sectionid = '" & section1 & "'WHERE id = " & id & ""
    ...
    Private Sub Form1_Paint(sender As Object, e As PaintEventArgs) Handles Me.Paint
        Dim themes As Boolean
        If theme.nightheme(themes) = True Then
